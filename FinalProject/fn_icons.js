...
/*
   ...
   Author: Denzcel Miranda
   Date: 06/21/2021   
   
   Filename: fn_icons.js
      ...
      if (bubbleBox.childElementCount <= 20) {
		 ...
		 var bubbleInterval = setInterval(function(){
			 ...
			 if(newBubble.opacity < 0) {
				 ...
				 bubbleImg.style.filter = 
					"hue-rotate(" + newBubble.hue + "deg)";
				newBubble.rotateBubble();
				bubbleImg.style.transform =
				"rotate(" + newBubble.rotate + "deg)";
